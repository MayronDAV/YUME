...
namespace YUME
{
	class VulkanRendererAPI : public RendererAPI
	{
		public:
			...
			void Draw(const Ref<VertexBuffer>& p_VertexBuffer, uint32_t p_VertexCount, uint32_t p_InstanceCount = 1) override;
			void DrawIndexed(const Ref<VertexBuffer>& p_VertexBuffer, const Ref<IndexBuffer>& p_IndexBuffer, uint32_t p_InstanceCount = 1) override;
		private:
